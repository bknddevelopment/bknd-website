            ...
            <div className="max-w-3xl space-y-12">
              ...
              <AnimateOnScroll delay={0.05}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    legally binding agreement between you and BKND Development
                    (&quot;Company,&quot; &quot;we,&quot; &quot;our,&quot; or
                    &quot;us&quot;) governing your access to and use of our
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    these Terms, you may not access our website or use our
                    services.
                  </p>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    BKND Development provides digital marketing services
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed mt-4">
                    ...
                    individual project proposals, statements of work, or service
                    agreements between you and BKND Development.
                  </p>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    <li>
                      Provide accurate and complete information necessary for us
                    ...
                    <li>
                      Ensure all content and materials provided to us do not
                      infringe on third-party rights
                    </li>
                    <li>
                      Comply with all applicable laws and platform terms of
                      service
                    </li>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <h3 className="text-[#1D1D1F] text-lg font-medium mt-6">
                    Fees and Invoicing
                  </h3>
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    Payment terms will be specified in your service agreement or
                    proposal. Unless otherwise agreed in writing:
                  </p>
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    <li>Invoices are due within 30 days of receipt</li>
                    <li>
                      Project-based work may require deposits before work
                      commences
                    </li>
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    (18% annually) or the maximum rate permitted by law,
                    whichever is lower. We reserve the right to suspend services
                    for accounts with outstanding balances exceeding 30 days.
                  </p>
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    For paid advertising services, advertising spend is separate
                    from our management fees and is billed directly by the
                    advertising platforms (Google, Meta, etc.) or as specified
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    You retain all ownership rights to materials, content,
                    trademarks, and other intellectual property you provide to
                    us. You grant us a non-exclusive license to use these
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    Unless otherwise specified in writing, upon full payment,
                    you will own the final deliverables created specifically for
                    your project. We retain ownership of:
                  </p>
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    <li>Our proprietary tools, processes, and methodologies</li>
                    <li>
                      General knowledge and skills developed during the
                      engagement
                    </li>
                    <li>
                      Pre-existing materials incorporated into deliverables
                    </li>
                  </ul>
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    Unless you notify us otherwise in writing, we may include
                    general descriptions of our work with you in our portfolio,
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    includes business strategies, financial data, customer
                    information, and other sensitive materials.
                  </p>
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    Confidential information does not include information that
                    is publicly available, independently developed, or
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    TO THE MAXIMUM EXTENT PERMITTED BY LAW, BKND DEVELOPMENT
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    or our services shall not exceed the total amount paid by
                    you to us in the six (6) months preceding the claim.
                  </p>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    While we strive to deliver results, we do not guarantee
                    specific outcomes such as search rankings, traffic levels,
                    conversion rates, or revenue increases, as these depend on
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    You agree to indemnify, defend, and hold harmless BKND
                    Development, its officers, directors, employees, and agents
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    Either party may terminate service agreements according to
                    the terms specified in the applicable service agreement or
                    proposal. In the absence of specific terms:
                  </p>
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    <li>
                      Monthly services may be terminated with 30 days written
                      notice
                    </li>
                    <li>
                      Project-based work may be terminated for cause with 15
                      days written notice
                    </li>
                    <li>
                      We may terminate immediately for non-payment or material
                      breach
                    </li>
                  </ul>
                  <p className="text-[#1D1D1F] text-base leading-relaxed mt-4">
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    these Terms or our services shall be resolved in the state
                    or federal courts located in New Jersey, and you consent to
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    to attempt to resolve disputes through good-faith
                    negotiation. If negotiation fails, the parties may pursue
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    updated Terms on our website with a new &quot;Last
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    These Terms, together with any applicable service
                    agreements, proposals, or statements of work, constitute the
                    entire agreement between you and BKND Development regarding
                    the subject matter herein and supersede all prior agreements
                    and understandings.
                  </p>
                </div>
              </AnimateOnScroll>
