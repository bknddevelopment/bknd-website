...
export const metadata: Metadata = {
  ...
  description:
    "Plain-English definitions for digital marketing and web development terms.",
};

export default function GlossaryHub() {
  const posts = getContentByCategory("glossary");
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          <AnimateOnScroll>
            ...
            <p className="text-lg text-[#86868B] mb-12 max-w-2xl">
              Plain-English definitions for digital marketing and web
              development terms.
            </p>
          </AnimateOnScroll>
