...
export async function generateMetadata({
  ...
  return {
    title: `${post.title} | Industry News | BKND Development`,
    ...
    openGraph: {
      ...
      authors: [post.author],
      url: `https://bknddevelopment.com/industry-news/${slug}`,
      images: post.image
        ? [
            {
...
export default async function NewsArticlePage({ params }: PageProps) {
  ...
  const pageUrl = `https://bknddevelopment.com/industry-news/${post.slug}`;
    ...
    // BreadcrumbList schema
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          position: 2,
          name: "Industry News",
          item: "https://bknddevelopment.com/industry-news",
        },
        {
          "@type": "ListItem",
          position: 3,
