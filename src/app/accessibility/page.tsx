            ...
            <div className="max-w-3xl space-y-12">
              ...
              <AnimateOnScroll delay={0.05}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    BKND Development is committed to ensuring digital
                    accessibility for people with disabilities. We are
                    continually improving the user experience for everyone and
                    applying the relevant accessibility standards to guarantee
                    we provide equal access to all users.
                  </p>
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    We believe that the web should be accessible to all,
                    regardless of ability or technology used to access it.
                    Accessibility is not just a legal requirement; it&apos;s a
                    core value that reflects our commitment to inclusivity.
                  </p>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    BKND Development strives to conform to WCAG 2.1 Level AA
                    standards. We are actively working to achieve and maintain
                    this level of accessibility across our website.
                  </p>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    <li>
                      Consistent and predictable navigation throughout the site
                    </li>
                  ...
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    ...
                    <li>
                      Color is not used as the sole means of conveying
                      information
                    </li>
                  ...
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    ...
                    <li>
                      Descriptive link text that indicates the purpose of each
                      link
                    </li>
                  ...
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    ...
                    <li>
                      Form inputs with visible labels and clear instructions
                    </li>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed mt-4">
                    We recommend using the latest versions of browsers and
                    assistive technologies for the best experience.
                  </p>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    ...
                    <li>
                      Third-party content or embedded applications may not meet
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed mt-4">
                    ...
                    improve accessibility throughout our website.
                  </p>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    ...
                    <li>
                      Any other information that might help us understand and
                      address the issue
                    </li>
                  </ul>
                  <p className="text-[#1D1D1F] text-base leading-relaxed mt-4">
                    We will make reasonable efforts to respond to accessibility
                    feedback within 5 business days and to address reported
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    If you are unable to access any content or use any features
                    of our website due to a disability, please contact us and we
                    will work with you to provide the information or service you
                    need through an alternative accessible format.
                  </p>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    embedded content from external services. We are not
                    responsible for the accessibility of third-party content.
                    However, we encourage you to contact us if you encounter
                    accessibility issues with any linked content, and we will
                    work with those providers when possible.
                  </p>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    of our website. Our ongoing efforts include:
                  </p>
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    <li>Regular accessibility audits and testing</li>
                    <li>
                      Incorporating accessibility into our design and
                      development process
                    </li>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4 pb-8">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    This accessibility statement applies to the BKND Development
                    website (bknddevelopment.com). We are committed to
                    compliance with:
                  </p>
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed mt-4">
                    This statement was created on January 2025 and is reviewed
                    and updated periodically to reflect changes to our website
