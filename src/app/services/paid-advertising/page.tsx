...
export const metadata: Metadata = {
  title:
    "Paid Advertising Services | ROI-Driven PPC Management | BKND Development",
  description:
    "Data-driven paid advertising that delivers measurable ROI. Google Ads, Meta Ads, LinkedIn Ads & programmatic campaigns managed by developers who understand tracking.",
  keywords:
    "paid advertising, PPC management, Google Ads, Meta Ads, Facebook Ads, LinkedIn Ads, programmatic advertising, ROI optimization, conversion tracking",
  openGraph: {
...
const platforms = [
  {
    ...
    title: "Google Ads",
    description:
      "Search, Display, Shopping, and YouTube campaigns. We capture intent when it matters most.",
  },
  {
    icon: Eye,
    title: "Meta Ads",
    description:
      "Facebook and Instagram advertising with precise audience targeting and creative optimization.",
  },
  {
    icon: TrendingUp,
    title: "LinkedIn Ads",
    description:
      "B2B lead generation targeting decision-makers by job title, company, and industry.",
  },
  {
    icon: Zap,
    title: "Programmatic",
    description:
      "Automated media buying across premium inventory with real-time bidding optimization.",
  },
];
...
const approach = [
  {
    ...
    title: "Audit",
    description:
      "We analyze your current campaigns, tracking setup, and conversion paths. Most accounts have significant waste hiding in plain sight.",
  },
  {
    step: "02",
    title: "Strategy",
    description:
      "We build a data-backed media plan aligned with your business goals. No vanity metrics—just revenue-focused KPIs.",
  },
  {
    step: "03",
    title: "Launch",
    description:
      "Campaigns go live with proper tracking from day one. Server-side tracking, enhanced conversions, and first-party data integration.",
  },
  {
    step: "04",
    title: "Optimize",
    description:
      "Continuous testing and refinement. We iterate on audiences, creative, and bidding strategies to maximize performance.",
  },
  {
    step: "05",
    title: "Scale",
    description:
      "Once we find what works, we scale strategically. New channels, expanded audiences, increased budgets—with maintained efficiency.",
  },
];
...
const aiFeatures = [
  {
    ...
    description:
      "Machine learning algorithms analyze thousands of signals in real-time to optimize bids at the keyword, audience, and placement level—far beyond what manual management can achieve.",
  },
  {
    icon: Gauge,
    title: "Predictive Budget Allocation",
    description:
      "AI forecasts performance across channels and automatically shifts budget to highest-performing campaigns. Your spend flows where the returns are.",
  },
  {
    icon: Sparkles,
    title: "Creative Testing Automation",
    description:
      "Automated multivariate testing of ad copy, images, and CTAs. AI identifies winning combinations and phases out underperformers without manual intervention.",
  },
  {
    icon: Layers,
    title: "Cross-Channel AI Optimization",
    description:
      "Unified AI optimization across Google, Meta, LinkedIn, and programmatic. One brain coordinating your entire paid media ecosystem for maximum efficiency.",
  },
  {
    icon: Activity,
    title: "Real-Time Performance Adjustments",
    description:
      "AI monitors campaigns 24/7 and makes micro-adjustments in milliseconds. Pause underperformers, boost winners, and respond to market changes instantly.",
  },
];
...
const benefits = [
  {
    ...
    description:
      "Real-time dashboards showing exactly where every dollar goes. No black boxes, no hidden fees, no surprises.",
  },
  {
    icon: Code,
    title: "Developer-Built Tracking",
    description:
      "Server-side tracking, enhanced conversions, and first-party data capture. Your attribution actually works.",
  },
  {
    icon: DollarSign,
    title: "No Long Contracts",
    description:
      "Month-to-month engagements. We earn your business with results, not lock-ins.",
  },
  {
    icon: LineChart,
    title: "True ROI Focus",
    description:
      "We optimize for revenue and profit, not clicks or impressions. Your CFO will appreciate us.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "We recommend a minimum of $3,000/month in ad spend to gather meaningful data and optimize effectively. However, the right budget depends on your industry, competition, and goals. We'll help you determine the optimal starting point during our strategy call.",
  },
  {
    question: "How is your approach different from other agencies?",
    answer:
      "We're developers first. That means proper tracking implementation, server-side conversions, and technical integrations that most agencies can't deliver. We build the infrastructure to actually measure ROI—not just report on vanity metrics.",
  },
  {
    question: "How long until I see results?",
    answer:
      "You'll see data from day one. Meaningful optimization typically takes 2-4 weeks as we gather conversion data. Most clients see significant improvement within 60-90 days. We set realistic expectations and provide clear milestones throughout.",
  },
  {
    question: "Do you require long-term contracts?",
    answer:
      "No. We work month-to-month because we believe in earning your business with results. Our retention comes from performance, not legal lock-ins. You can cancel anytime with 30 days notice.",
  },
];
      ...
      <main>
            ...
            <div className="max-w-3xl">
              ...
              <AnimateOnScroll delay={0.2}>
                <p className="text-[#86868B] text-lg lg:text-xl leading-relaxed max-w-2xl mb-8">
                  Most agencies report on clicks. We report on revenue. Our
                  developer-first approach means every conversion is tracked,
                  every dollar is accounted for, and every campaign is optimized
          ...
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                From awareness to conversion, we manage campaigns across every
                major platform.
              </p>
            </AnimateOnScroll>
          ...
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-gray-400 text-lg lg:text-xl text-center mb-16 max-w-2xl mx-auto">
                No guesswork. No hoping for the best. Just a proven process that
                delivers results.
              </p>
            </AnimateOnScroll>
        ...
        <section className="py-16 lg:py-24 bg-[#F5F5F7]">
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                Maximize ROAS through continuous AI optimization. Our machine
                learning systems work around the clock to squeeze every drop of
                performance from your ad spend.
              </p>
            </AnimateOnScroll>
            ...
            <AnimateOnScroll delay={0.7}>
              <div className="mt-12 bg-[#1D1D1F] rounded-2xl p-8 lg:p-10">
                <div className="grid md:grid-cols-3 gap-8 text-center">
                  <div>
                    <p className="text-[#00D4FF] text-4xl lg:text-5xl font-semibold mb-2">
                      24/7
                    </p>
        ...
        <section className="py-16 lg:py-24 bg-white">
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                We approach paid media like engineers: systematic, measurable,
              ...
              <div>
                ...
                <AnimateOnScroll delay={0.2}>
                  <p className="text-[#86868B] text-lg leading-relaxed mb-6">
                    A B2B SaaS company came to us spending $50k/month on Google
                    Ads with no clear attribution. After implementing proper
                    tracking and restructuring their campaigns, we achieved a
                    4.2x return on ad spend within 90 days.
                  </p>
                </AnimateOnScroll>
            ...
            <div className="max-w-3xl mx-auto text-center">
              <AnimateOnScroll>
                ...
                <p className="text-xl lg:text-2xl text-gray-400 font-normal mb-12 max-w-xl mx-auto">
                  Get a free audit of your current campaigns and see where the
                  opportunities are.
                </p>
              </AnimateOnScroll>
