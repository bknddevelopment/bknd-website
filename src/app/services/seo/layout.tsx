...
export const metadata: Metadata = {
  title:
    "Technical SEO Services | Developer-Built Optimization | BKND Development",
  description:
    "SEO built by developers, for results. Technical SEO, Core Web Vitals optimization, schema markup, and data-driven content strategy. No black hat tactics, just sustainable growth.",
  keywords: [
    "technical SEO",
    "SEO services",
  ...
  openGraph: {
    ...
    description:
      "SEO built by developers, for results. Technical optimization, schema markup, and data-driven strategies for sustainable organic growth.",
    type: "website",
    locale: "en_US",
  ...
  twitter: {
    ...
    title: "Technical SEO Services | BKND Development",
    description:
      "SEO built by developers, for results. Technical optimization, schema markup, and data-driven strategies.",
        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              ...
              name: "Technical SEO",
              description:
                "Site architecture, schema markup, crawlability, indexation, and Core Web Vitals optimization.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Content structure, meta tags, heading hierarchy, internal linking, and keyword targeting.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              name: "Local SEO",
              description:
                "Google Business Profile optimization, local citations, review management, and geo-targeted content.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Keyword research, content gap analysis, topic clusters, and editorial calendars.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              name: "Link Building",
              description:
                "White-hat outreach, digital PR, and authority building through genuine relationships.",
            },
          },
        ],
      },
