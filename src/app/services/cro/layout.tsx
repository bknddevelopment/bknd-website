...
export const metadata: Metadata = {
  ...
  description:
    "Data-driven conversion rate optimization that turns visitors into customers. A/B testing, landing page optimization, user research, and funnel analysis with measurable results.",
  keywords: [
  ...
  openGraph: {
    title: "CRO Services | Conversion Rate Optimization | BKND Development",
    description:
      "Data-driven conversion rate optimization that turns visitors into customers. A/B testing, landing page optimization, and funnel analysis.",
    type: "website",
    locale: "en_US",
  ...
  twitter: {
    ...
    description:
      "Data-driven conversion rate optimization that turns visitors into customers.",
  },
  alternates: {
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description:
            "Transform underperforming pages into conversion engines through data-driven optimization.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          name: "A/B Testing",
          description:
            "Statistical testing to validate hypotheses and implement winning variations.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Heatmaps, session recordings, and user surveys to identify friction points.",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Map and optimize your entire conversion funnel to improve each step of the customer journey.",
        },
      },
    ],
  },
