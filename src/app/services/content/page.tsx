...
const contentServices = [
  {
    ...
    title: "Blog Content",
    description:
      "SEO-optimized articles that rank and convert. We research, write, and optimize content that drives organic traffic and establishes thought leadership.",
  },
  {
    icon: BookOpen,
    title: "Case Studies",
    description:
      "Compelling success stories that showcase your results. Data-driven narratives that build credibility and help prospects see themselves in your solutions.",
  },
  {
    icon: PenTool,
    title: "Whitepapers & Guides",
    description:
      "In-depth resources that generate qualified leads. Research-backed content that positions you as the authority in your space.",
  },
  {
    icon: Mail,
    title: "Email Sequences",
    description:
      "Nurture campaigns that move prospects through your funnel. Strategic sequences from welcome series to re-engagement campaigns.",
  },
  {
    icon: Share2,
    title: "Social Content",
    description:
      "Platform-native content that engages and converts. LinkedIn thought leadership, Twitter threads, and content repurposing strategies.",
  },
];
...
const approachSteps = [
  {
    ...
    title: "Research",
    description:
      "Deep dive into your audience, competitors, and keywords to identify content opportunities.",
  },
  {
    number: "02",
    title: "Strategy",
    description:
      "Build a content roadmap aligned with business goals and buyer journey stages.",
  },
  {
    number: "03",
    title: "Create",
    description:
      "Produce high-quality content that balances SEO best practices with engaging storytelling.",
  },
  {
    number: "04",
    title: "Distribute",
    description:
      "Amplify content across channels to maximize reach and engagement.",
  },
  {
    number: "05",
    title: "Measure",
    description:
      "Track performance, gather insights, and continuously optimize for better results.",
  },
];
...
const benefits = [
  {
    ...
    title: "SEO-Optimized",
    description:
      "Every piece is built to rank. Keyword research, proper structure, and technical SEO baked into the process.",
  },
  {
    icon: Target,
    title: "Conversion-Focused",
    description:
      "Content designed to move readers to action. Strategic CTAs and persuasive frameworks throughout.",
  },
  {
    icon: Users,
    title: "Brand-Aligned",
    description:
      "Your voice, amplified. We learn your tone, values, and positioning to create content that feels authentically you.",
  },
];
...
const aiFeatures = [
  {
    ...
    description:
      "Generate high-quality drafts 10x faster. Our AI tools handle research, outlines, and initial drafts while human editors ensure every piece meets your brand standards.",
  },
  {
    icon: Brain,
    title: "AI-Assisted Research",
    description:
      "Comprehensive briefs in minutes, not hours. AI analyzes competitors, extracts insights, and surfaces opportunities humans might miss.",
  },
  {
    icon: Zap,
    title: "Automated SEO Optimization",
    description:
      "Real-time optimization suggestions as content is created. AI handles keyword density, readability scoring, and technical SEO so writers can focus on storytelling.",
  },
  {
    icon: Users2,
    title: "Human + AI Collaboration",
    description:
      "AI amplifies human creativity, never replaces it. Writers guide strategy and voice while AI handles repetitive tasks and data analysis.",
  },
  {
    icon: Bot,
    title: "LLM-Ready Content",
    description:
      "Content structured for how AI systems read and cite information. Clear hierarchies, factual density, and citation-friendly formatting for the AI-search era.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "We start with a comprehensive brand voice guide and content brief process. Every piece goes through our editorial workflow: research, outline approval, draft, revision, and final polish. You maintain full approval authority while we handle the heavy lifting.",
  },
  {
    question: "What makes your content different from other agencies?",
    answer:
      "We combine SEO expertise with genuine storytelling. Our developer-first background means we understand how to make content work technically (proper schema, internal linking, keyword optimization) while still being engaging and valuable to readers. No keyword-stuffed fluff.",
  },
  {
    question: "How long does it take to see results from content marketing?",
    answer:
      "Content marketing is a compounding investment. You'll typically see initial ranking improvements within 3-4 months, with significant traffic growth at 6-12 months. We focus on evergreen content that continues to drive value for years, not just quick wins.",
  },
  {
    question: "Do you handle content distribution and promotion?",
    answer:
      "Yes. Content creation is only half the battle. We develop distribution strategies including social amplification, email integration, internal linking, and outreach for backlinks. Our goal is maximizing the ROI of every piece we create.",
  },
];
      ...
      <main>
            ...
            <div className="max-w-3xl">
              ...
              <AnimateOnScroll delay={0.1}>
                <h1 className="text-[32px] sm:text-[40px] lg:text-[52px] font-semibold text-[#1D1D1F] mb-6 leading-[1.1] tracking-[-0.02em]">
                  Content That <span className="text-[#00D4FF]">Converts.</span>
                </h1>
              </AnimateOnScroll>

              <AnimateOnScroll delay={0.2}>
                <p className="text-[#86868B] text-lg lg:text-xl leading-relaxed max-w-2xl mb-8">
                  Strategy-first content that builds authority, drives organic
                  traffic, and turns readers into customers. We don&apos;t just
                  create content&mdash;we create content systems that compound.
                </p>
              </AnimateOnScroll>
          ...
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                From blog posts to thought leadership, we create content that
          ...
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-16 max-w-2xl mx-auto">
                We treat content like a product&mdash;with clear processes,
        ...
        <section className="py-16 lg:py-24 bg-white">
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                Every piece we create is designed to achieve specific business
                objectives.
              </p>
            </AnimateOnScroll>
        ...
        <section className="py-16 lg:py-24 bg-[#F5F5F7]">
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                Produce more content, faster, without sacrificing quality. Our
                AI-enhanced workflow lets your team focus on strategy while
            ...
            <AnimateOnScroll delay={0.2}>
              <div className="bg-[#1D1D1F] rounded-2xl p-6 lg:p-8 mb-12">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                  <div className="text-center">
                    <p className="text-3xl lg:text-4xl font-semibold text-[#00D4FF]">
                      10x
                    </p>
              ...
              <div className="mt-12 bg-white rounded-2xl p-6 lg:p-8 border border-[#00D4FF]/20">
                <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4 lg:gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-[#86868B] leading-relaxed">
                      Every piece of content is crafted by experienced writers
                      who use AI as a research assistant and first-draft
                      tool&mdash;never as a replacement for human judgment,
                      creativity, and brand understanding. Your voice stays
                      authentic because real people ensure it does.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="relative z-10 grid lg:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <p className="text-gray-400 leading-relaxed mb-6">
                      See how we helped a B2B SaaS company build a content
                      engine that generates thousands of qualified leads monthly
                      through SEO-optimized thought leadership.
                    </p>
