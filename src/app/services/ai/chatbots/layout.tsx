...
export const metadata: Metadata = {
  title:
    "AI Chatbots & Assistants | 24/7 Lead Capture & Support | BKND Development",
  description:
    "AI chatbots that convert visitors into customers. 24/7 intelligent engagement that qualifies leads, answers questions, and books meetings—while you focus on closing deals.",
  keywords: [
    "AI chatbots",
    "chatbot development",
    "conversational AI",
  ...
  openGraph: {
    ...
    description:
      "AI chatbots that convert visitors into customers. 24/7 intelligent engagement that qualifies leads, answers questions, and books meetings.",
    type: "website",
    locale: "en_US",
  ...
  twitter: {
    ...
    title: "AI Chatbots & Assistants | BKND Development",
    description:
      "AI chatbots that convert visitors into customers. 24/7 intelligent engagement that qualifies leads and books meetings.",
...
const jsonLd = {
  ...
  "@graph": [
    // Service Schema
    {
      ...
      description:
        "Custom AI chatbot development for customer service, sales qualification, lead capture, and multi-channel deployment. 24/7 intelligent engagement that converts visitors into customers.",
      provider: {
        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              ...
              description:
                "Handle FAQs, troubleshoot issues, and reduce support ticket volume with intelligent automation.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Qualify leads in real-time, book demos automatically, and capture contact information.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Engage visitors with personalized conversations and route hot leads to sales teams.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "Deploy chatbots across website, SMS, Facebook Messenger, WhatsApp, and more.",
            },
          },
          {
            "@type": "Offer",
            itemOffered: {
              ...
              description:
                "AI trained on your data, speaking in your voice, following your processes.",
            },
          },
        ],
      },
