...
export const metadata: Metadata = {
  title:
    "Custom AI Solutions | RAG, AI Agents & Enterprise AI | BKND Development",
  description:
    "Custom AI solutions built for your business. RAG implementations, bespoke AI agents, AI integration services, and industry-specific AI that solves your specific challenges.",
  keywords: [
    "custom AI solutions",
    "RAG implementation",
    "AI agents",
  ...
  twitter: {
    ...
    description:
      "Custom AI built on your data, trained for your use cases, integrated with your systems.",
  },
  alternates: {
...
const jsonLd = {
  ...
  description:
    "Custom AI solutions built for your business. RAG implementations, bespoke AI agents, AI integration services, and industry-specific AI that solves your specific challenges and drives measurable results.",
  provider: {
    "@type": "Organization",
