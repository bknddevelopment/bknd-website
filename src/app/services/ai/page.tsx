...
const services = [
  {
    ...
    description:
      "24/7 customer engagement that converts. Our AI chatbots handle inquiries, qualify leads, and book meetings while you sleep.",
  ...
  },
  {
    ...
    description:
      "Workflows that learn and optimize. From email sequences to customer journeys, AI-powered automation that gets smarter over time.",
  ...
  },
  {
    ...
    description:
      "Bespoke AI built for your business. From RAG implementations to custom agents, we build AI that solves your specific challenges.",
  ...
  },
  {
    ...
    description:
      "Get found in AI search. Optimize your content for ChatGPT, Gemini, Perplexity, and the new wave of AI-powered search.",
...
const whyBKND = [
  {
    ...
    description:
      "No decks, no hand-offs. We build and deploy working AI solutions directly into your marketing stack.",
  },
  {
    icon: Sparkles,
    title: "Developer-built means we implement directly",
    description:
      "Our technical foundation means no waiting on third parties. We code, test, and deploy AI solutions in-house.",
  },
  {
    icon: DollarSign,
    title: "Revenue-focused, not technology-focused",
    description:
      "We don't chase shiny AI features. Every solution we build is tied to measurable business outcomes.",
  },
  {
    icon: Users,
    title: "Full marketing integration, not siloed AI projects",
    description:
      "Your AI solutions work seamlessly with your SEO, content, and paid strategies for compounding returns.",
  },
];
...
const stats = [
  {
    ...
    description:
      "AI-powered workflows deliver significantly higher returns through intelligent optimization.",
  },
  {
    value: "60%",
    label: "of inquiries resolved by AI chatbots",
    description:
      "Free your team to focus on high-value conversations while AI handles routine questions.",
  },
  {
    value: "$50B+",
    label: "AI services market by 2030",
    description:
      "The businesses adopting AI now will dominate their markets. Don't get left behind.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Most AI chatbots can be deployed in 2-4 weeks. More complex solutions like custom RAG systems or multi-agent workflows typically take 6-12 weeks depending on scope and integration requirements.",
  },
  {
    question: "Will AI replace our marketing team?",
    answer:
      "No. AI amplifies your team's capabilities, handling repetitive tasks and data processing so your people can focus on strategy, creativity, and relationship-building. Think of it as a force multiplier, not a replacement.",
  },
  {
    question: "How do you ensure AI outputs match our brand voice?",
    answer:
      "We train AI systems on your existing content, brand guidelines, and communication style. Plus, we build in human review checkpoints for anything customer-facing until you're confident in the outputs.",
  },
  {
    question: "What if AI makes mistakes or gives wrong information?",
    answer:
      "We implement guardrails, fact-checking systems, and fallback protocols. For critical use cases, we design human-in-the-loop workflows. The goal is helpful automation with appropriate safety nets.",
  },
];
            ...
            <div className="max-w-3xl">
              ...
              <AnimateOnScroll delay={0.2}>
                <p className="text-[#86868B] text-lg lg:text-xl leading-relaxed max-w-2xl mb-8">
                  We combine AI&apos;s speed and scale with human creativity and
                  strategy. The result? Marketing that&apos;s smarter, faster,
                  and more profitable.
                </p>
              </AnimateOnScroll>
          ...
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                From conversational AI to workflow automation, we build AI that
          ...
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-gray-400 text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                We don&apos;t just advise on AI—we build it, deploy it, and make
            ...
            <div className="max-w-3xl mx-auto text-center">
              <AnimateOnScroll>
                ...
                <p className="text-xl lg:text-2xl text-gray-400 font-normal mb-12 max-w-xl mx-auto">
                  Get a free AI assessment and discover how AI can transform
