...
export const metadata: Metadata = {
  title: 'AI Marketing Automation | Intelligent Workflows & Lead Scoring | BKND Development',
  description: 'AI-powered marketing automation that learns and optimizes. Email sequences, customer journeys, lead scoring, and predictive personalization. 250-300% ROI vs traditional automation.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'AI-powered marketing automation that learns and optimizes. Email sequences, customer journeys, lead scoring, and predictive personalization.',
    type: 'website',
    locale: 'en_US',
...
const jsonLd = {
  ...
  description: 'AI-powered marketing automation including email campaigns, customer journey automation, lead scoring, and predictive personalization.',
  provider: {
    '@type': 'Organization',
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description: 'AI-optimized email sequences with predictive send times.',
        },
      },
      {
        '@type': 'Offer',
      ...
      },
      {
        ...
        itemOffered: {
          ...
          description: 'AI that identifies bottlenecks and suggests improvements.',
        },
      },
    ],
  },
