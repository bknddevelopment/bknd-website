...
export const metadata: Metadata = {
  title: 'Generative Engine Optimization (GEO) | AI Search Optimization | BKND Development',
  description: 'Get found in AI search. GEO optimizes your content for ChatGPT, Gemini, Perplexity, and other AI platforms. Be cited, referenced, and recommended in AI-generated answers.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Get found in AI search. Optimize your content for ChatGPT, Gemini, and Perplexity. Be the source AI trusts and cites.',
    type: 'website',
    locale: 'en_US',
  ...
  twitter: {
    ...
    title: 'Generative Engine Optimization (GEO) | BKND Development',
    description: 'Get found in AI search. Optimize for ChatGPT, Gemini, Perplexity, and AI platforms.',
...
const jsonLd = {
  ...
  '@graph': [
    ...
    {
      '@type': 'Service',
      '@id': 'https://charwinvanryckdegroot.github.io/bknd-website/services/ai/geo#service',
      name: 'Generative Engine Optimization (GEO)',
      description: 'GEO services that optimize your content for AI search engines including ChatGPT, Google Gemini, Perplexity, Claude, and Microsoft Copilot. Get cited, referenced, and recommended in AI-generated answers.',
      provider: {
        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              ...
              description: 'Analyze how AI platforms currently perceive and cite your brand across ChatGPT, Gemini, and Perplexity.',
            },
          },
          {
            '@type': 'Offer',
            itemOffered: {
              ...
              description: 'Structure content for large language model understanding and optimal information retrieval.',
            },
          },
          {
            '@type': 'Offer',
            itemOffered: {
              ...
              description: 'Engineer content that AI systems reference and cite when answering user queries.',
            },
          },
          {
            '@type': 'Offer',
            itemOffered: {
              ...
              description: 'Format information architecture for optimal AI consumption with clear hierarchies and semantic relationships.',
            },
          },
          {
            '@type': 'Offer',
            itemOffered: {
              ...
              description: 'Monitor visibility across AI platforms including citations, references, and brand mentions.',
            },
          },
        ],
      },
    ...
    {
      '@type': 'WebPage',
      '@id': 'https://charwinvanryckdegroot.github.io/bknd-website/services/ai/geo#webpage',
      url: 'https://charwinvanryckdegroot.github.io/bknd-website/services/ai/geo',
      name: 'Generative Engine Optimization (GEO) | AI Search Optimization | BKND Development',
      description: 'Get found in AI search. GEO optimizes your content for ChatGPT, Gemini, Perplexity, and other AI platforms.',
      isPartOf: {
    ...
    {
      '@type': 'FAQPage',
      '@id': 'https://charwinvanryckdegroot.github.io/bknd-website/services/ai/geo#faq',
      mainEntity: [
        {
          '@type': 'Question',
