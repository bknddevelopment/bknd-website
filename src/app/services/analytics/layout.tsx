...
export const metadata: Metadata = {
  title: 'Data & Analytics Services | GA4, Tracking & Dashboards | BKND Development',
  description: 'Developer-built analytics that actually work. GA4 setup, tracking implementation, custom dashboards, and attribution modeling. Get data you can use to drive business decisions.',
  keywords: [
    'GA4 setup',
    'Google Analytics 4',
  ...
  openGraph: {
    ...
    description: 'Developer-built analytics that actually work. GA4 setup, tracking implementation, custom dashboards, and attribution modeling.',
    type: 'website',
    locale: 'en_US',
    siteName: 'BKND Development',
    url: 'https://charwinvanryckdegroot.github.io/bknd-website/services/analytics',
  },
  twitter: {
...
const jsonLd = {
  ...
  description: 'Developer-built analytics including GA4 setup, tracking implementation, custom dashboards, and attribution modeling.',
  provider: {
    '@type': 'Organization',
    ...
    itemListElement: [
      {
        ...
        itemOffered: {
          ...
          description: 'Complete Google Analytics 4 implementation with custom events, conversions, and e-commerce tracking.',
        },
      },
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          description: 'Server-side tagging, cross-domain tracking, and custom event architectures.',
        },
      },
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          description: 'Real-time dashboards built in Looker Studio or your preferred platform.',
        },
      },
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          description: 'Multi-touch attribution that shows the true customer journey.',
        },
      },
    ],
  },
