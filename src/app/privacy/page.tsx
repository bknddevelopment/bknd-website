              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed mt-4">
                    ...
                    number, company name, job title, and any other information
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    and track information about your browsing activities.
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    conducting our business. These providers include:
                  </p>
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed mt-4">
                    ...
                    your information and use it only for the purposes we
                    specify.
                  </p>
                </div>
              </AnimateOnScroll>
              ...
              <AnimateOnScroll delay={0.1}>
                <div className="space-y-4">
                  ...
                  <p className="text-[#1D1D1F] text-base leading-relaxed">
                    ...
                    Privacy Act (CCPA) provides you with specific rights
                  ...
                  <ul className="list-disc list-inside text-[#1D1D1F] text-base leading-relaxed space-y-2 ml-4">
                    ...
                    <li>
                      Right to non-discrimination for exercising your CCPA
                      rights
                    </li>
                  </ul>
                  <p className="text-[#1D1D1F] text-base leading-relaxed mt-4">
                    We do not sell your personal information as defined under
                    the CCPA.
                  </p>
                </div>
              </AnimateOnScroll>
