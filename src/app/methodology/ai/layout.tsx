...
export const metadata: Metadata = {
  ...
  description:
    "Our proven 5-phase AI implementation methodology: Assess, Strategize, Build, Deploy, Optimize. Transform your marketing with AI solutions that deliver measurable ROI.",
  keywords: [
  ...
  twitter: {
    ...
    description:
      "Our proven 5-phase AI implementation methodology delivers measurable ROI.",
