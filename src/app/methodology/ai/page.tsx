...
const phases = [
  {
    ...
    outcomes: 'Clear understanding of where you are, where you could be, and what it takes to get there.',
  },
  {
    id: 'strategize',
    number: '02',
    ...
    outcomes: 'A clear path forward with prioritized initiatives, realistic timelines, and measurable goals.',
  },
  {
    id: 'build',
    number: '03',
    ...
    outcomes: 'Production-ready AI solutions that integrate seamlessly with your existing marketing stack.',
  },
  {
    id: 'deploy',
    number: '04',
    ...
    outcomes: 'AI solutions live in production with trained teams and monitoring in place.',
  },
  {
    id: 'optimize',
    number: '05',
    ...
    outcomes: 'Continuously improving AI performance with compounding returns over time.',
  },
];
...
const faqs = [
  ...
  {
    question: 'Do we need technical expertise to work with your AI methodology?',
    answer:
      ...
      <main>
            ...
            <div className="max-w-3xl">
              ...
              <AnimateOnScroll delay={0.2}>
                <p className="text-[#86868B] text-lg lg:text-xl leading-relaxed max-w-2xl mb-8">
                  Our proven 5-phase methodology turns AI potential into business results. From
                  readiness assessment to continuous optimization, we guide you through every step
          ...
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                The businesses implementing AI now will dominate their markets. Here&apos;s what
                the data shows.
              </p>
            </AnimateOnScroll>
          ...
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-gray-400 text-lg lg:text-xl text-center mb-16 max-w-2xl mx-auto">
                A systematic approach that minimizes risk, maximizes ROI, and ensures successful
                AI adoption at every stage.
              </p>
            </AnimateOnScroll>
                    ...
                    <div className="grid lg:grid-cols-12 gap-8">
                      ...
                      <div className="lg:col-span-4">
                        <div className="flex items-start gap-4 mb-6">
                          ...
                          <div>
                            ...
                            <p className="text-[#00D4FF] font-medium">{phase.subtitle}</p>
                          </div>
                        </div>
                      ...
                      <div className="lg:col-span-4">
                        ...
                        <div className="bg-[#00D4FF]/10 rounded-xl p-4 border border-[#00D4FF]/20">
                          <p className="text-[#00D4FF] text-sm font-medium mb-1">Outcome</p>
                          <p className="text-gray-300 text-sm">{phase.outcomes}</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <section className="py-16 lg:py-24 bg-[#F5F5F7]">
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                What sets our AI methodology apart from consultants and agencies.
              </p>
            </AnimateOnScroll>
              ...
              {differentiators.map((diff, i) => (
                <AnimateOnScroll key={i} delay={0.2 + i * 0.1}>
                  <div className="bg-white rounded-2xl p-8 h-full border border-gray-200/80 transition-all duration-300 hover:border-[#00D4FF]/50 hover:shadow-[0_0_20px_rgba(0,212,255,0.1)]">
                    ...
                    <h3 className="text-xl font-semibold text-[#1D1D1F] mb-3">{diff.title}</h3>
                    <p className="text-[#86868B] leading-relaxed">{diff.description}</p>
                  </div>
                </AnimateOnScroll>
              ))}
            </div>
        ...
        <section className="py-16 lg:py-24 bg-white">
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                Most clients see initial results within 30 days and full deployment within 12
                weeks.
              </p>
            </AnimateOnScroll>
                    ...
                    {[
                      {
                        ...
                        description: 'AI readiness score and opportunity matrix delivered.',
                      },
                      {
                        week: 'Week 3-5',
                      ...
                      },
                      {
                        week: 'Week 11-12',
                        title: 'Go Live',
                        description: 'Solutions deployed with team trained and monitoring active.',
                      },
                      {
                        week: 'Ongoing',
                      ...
                      <div key={i} className="flex gap-6 items-start">
                        ...
                        <div className="flex-1 pb-8">
                          ...
                          <p className="text-[#86868B]">{milestone.description}</p>
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        <section className="py-16 lg:py-24 bg-[#F5F5F7]">
          <div className="container-sg">
            ...
            <AnimateOnScroll delay={0.15}>
              <p className="text-[#86868B] text-lg lg:text-xl text-center mb-12 max-w-2xl mx-auto">
                Straight answers about our AI methodology and implementation process.
              </p>
            </AnimateOnScroll>
            ...
            <div className="max-w-3xl mx-auto text-center">
              <AnimateOnScroll>
                ...
                <h2 className="text-4xl lg:text-5xl xl:text-6xl font-semibold text-white tracking-tight mb-6">
                  Get Your Free
                  <br />
                  <span className="text-[#00D4FF]">AI Readiness Assessment</span>
                </h2>

                <p className="text-xl lg:text-2xl text-gray-400 font-normal mb-12 max-w-xl mx-auto">
                  Discover where you stand, what&apos;s possible, and how to get there. No
