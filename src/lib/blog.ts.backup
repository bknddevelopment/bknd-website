...
**NAP consistency.** Your name, address, and phone number must match exactly across your website, Google Business Profile, and every directory you're listed on. "123 Main St" and "123 Main Street" are different to Google.

**Schema markup.** LocalBusiness structured data on every location page. This tells Google explicitly that you serve that area. Your developer can implement this in under an hour.

For a roofing company serving 8-10 cities, building out proper location pages can generate 50+ additional organic leads per month. It's tedious work, but the compound returns are significant.
...
This sequence converts people who weren't ready on the doorstep into appointments later. The door knock starts the relationship. The digital follow-up closes it.
...
I've worked with HVAC contractors who turned away jobs in peak season because they couldn't handle the volume, then laid off technicians three months later. That's not a business model. That's a rollercoaster.
...
**Maintenance vs. replacement economics.** A $150 tune-up has a completely different customer acquisition cost tolerance than a $12,000 system replacement. Marketing both the same way means you're either overpaying for tune-up leads or underinvesting in replacement opportunities.
...
**The technical setup that matters:** Your website needs to load in under 2 seconds on mobile. When it's 102 degrees and the AC just died, nobody's waiting for your slow site. They're hitting back and calling the next result.
...
We've seen 30%+ response rates on weather-triggered text campaigns. Compare that to 2% email open rates for generic newsletters.
...
Stock photos do nothing. Google knows the difference. Customers know the difference.
...
Add questions your customers actually ask, then answer them thoroughly:
...
NAP = Name, Address, Phone Number. These must be identical everywhere. Not similar. Identical.
