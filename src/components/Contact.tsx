        ...
        <div className="container-sg">
          <AnimateOnScroll>
            <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 text-center max-w-3xl mx-auto">
              ...
              <span className="text-[#F27038]">Grow Your Business</span>
            </h2>
          </AnimateOnScroll>
        </div>
      </div>
          ...
          <AnimateOnScroll>
            <div className="max-w-4xl mx-auto relative">
              ...
              <div className="absolute left-0 top-8 hidden lg:flex flex-col gap-1">
                ...
                <div className="w-2 h-2 bg-[#F27038]" />
                <div className="w-2 h-2 bg-[#F27038]" />
                <div className="w-2 h-6 bg-[#F27038]" />
                <div className="w-2 h-2 bg-[#F27038]" />
              </div>

              <div className="bg-[#2F333B] rounded-2xl p-8 lg:p-12 ml-0 lg:ml-6">
                <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
                  {/* Left content - spans 3 columns */}
                  <div className="lg:col-span-3">
                    {/* Quick response badge */}
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-8 h-8 rounded-full bg-[#F27038]/20 flex items-center justify-center flex-shrink-0">
                        <svg className="w-4 h-4 text-[#F27038]" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <form className="space-y-4">
                      <input
                        ...
                        className="w-full bg-white/10 border border-white/30 rounded-lg px-5 py-4 text-white placeholder:text-gray-400 focus:outline-none focus:border-[#F27038] focus:bg-white/15 transition-colors text-base"
                        style={{ height: '54px' }}
                        value={email}
                  ...
                  <div className="lg:col-span-2 hidden lg:flex items-center justify-center">
                    ...
                    <div className="relative w-40 h-40">
                      <div className="absolute inset-0 bg-gradient-to-br from-[#F27038]/20 to-[#EFB438]/10 rounded-full blur-xl" />
                      <div className="absolute inset-4 bg-gradient-to-br from-[#F27038]/30 to-[#EFB438]/20 rounded-full" />
                      <div className="absolute inset-0 flex items-center justify-center">
                        <svg className="w-16 h-16 text-[#F27038]/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
