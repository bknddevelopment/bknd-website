        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-12 lg:gap-16 items-start pt-8 lg:pt-16">
          ...
          <div>
            ...
            >
              ...
              <span className="text-white text-sm font-medium">Limited slots available</span>
            ...
            {submitStatus === 'success' && (
              <p className={`text-green-400 text-sm mb-4 transition-all duration-500 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
                Thanks! We&apos;ll be in touch soon.
              </p>
            )}
            {submitStatus === 'error' && (
              <p className={`text-red-400 text-sm mb-4 transition-all duration-500 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
